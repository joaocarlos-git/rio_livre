...
type
  TFrmAgendamentoDetalhe = class(TForm)
    LytToolbar: TLayout;
    LblTitle: TLabel;
...
var
  FrmAgendamentoDetalhe: TFrmAgendamentoDetalhe;
...
procedure TFrmAgendamentoDetalhe.AddRecipiente(id_recipiente: integer;
                                    descricao: string;
...
procedure TFrmAgendamentoDetalhe.CarregarAgendamento;
begin
...
procedure TFrmAgendamentoDetalhe.FormShow(Sender: TObject);
begin
    CarregarAgendamento;
end;
